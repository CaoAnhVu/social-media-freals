...
const Actions = ({ post }) => {
  ...
  const handleRepost = async () => {
    ...
    try {
      ...
      console.log("Repost API Response Status:", res.status);
      ...
      setPosts([repost, ...posts]); // Thêm bài repost vào đầu danh sách bài viết
  ...
  return (
    <Flex flexDirection="column">
      <Flex gap={3} my={2} onClick={(e) => e.preventDefault()}>
        ...
        <svg aria-label="Repost" color="currentColor" fill="currentColor" height="20" role="img" viewBox="0 0 24 24" width="20" onClick={handleRepost}>
          <title>Repost</title>
          <path
            fill=""
        ...
        <svg aria-label="Share" color="" fill="rgb(243, 245, 247)" height="20" role="img" viewBox="0 0 24 24" width="20" onClick={handleShare}>
          <title>Share</title>
